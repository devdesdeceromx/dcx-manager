...
const initialData: DashboardData = { newProspects: 0, activeClients: 0, totalProspects: 0, pipeline: { new: 0, contacted: 0, qualified: 0, quote: 0, negotiation: 0, won: 0, lost: 0 }, activity: [] }
...
export function DashboardPage() {
  ...
  const metrics = [
    ...
    { label: 'Cotizaciones pendientes', value: '—', detail: 'Disponible en el próximo módulo', icon: FileText, ready: false },
